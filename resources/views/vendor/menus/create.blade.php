    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('vendor.menus.store') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-input id="price" type="number" name="price" :value="old('price')" required step="0.01"
                            min="0" class="mt-1 block w-full" />
                        <x-input-error for="price" class="mt-2" />
                    </div>

                    <div>
                        <x-label for="image" value="Menu Image (Optional)" />
